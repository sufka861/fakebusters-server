...
async function main() { 
  try {
    ...
    const oAuthAccessToken = await accessToken(oAuthRequestToken, client_secret?.trim());
...
export {accessToken,requestToken,getRequest,authorizeURL,client_secret,main}
